                ...
                <div class="container mx-auto px-4 py-12">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:border-gray-700">
                            ...
                            <a href="{{route('all-university')}}" wire:navigate class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                View Details
