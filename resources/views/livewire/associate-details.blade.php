<div>
    ...
    @if ($showAddForm)
        ...
        <form wire:submit.prevent="save" class="mb-4">
            <input type="text" wire:model="associate_name"
            ...
            <button
                style="background-color: #1e40af; color: #ffffff; font-weight: bold; padding: 0.5rem 1rem; border-radius: 0.25rem; border: none; outline: none; cursor: pointer; transition: background-color 0.3s ease;"
                type="submit"
                class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded ml-2">Add</button>
        </form>
    @endif
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <button
                                ...
                                wire:click="delete({{ $associate->id }})"
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                ...
                                <form wire:submit.prevent="update">
                                    ...
                                    <input type="text" wire:model="updateassociate_name"
                                        class="shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                        placeholder="Enter associate name">
                                    <button
                                        style="background-color: #1e40af; color: #ffffff; font-weight: bold; padding: 0.5rem 1rem; border-radius: 0.25rem; border: none; outline: none; cursor: pointer; transition: background-color 0.3s ease;"
